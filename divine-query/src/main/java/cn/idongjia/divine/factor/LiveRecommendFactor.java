...
@Getter
@Setter
public class LiveRecommendFactor implements Factor {
    private int    userType          = 0;
    private Double subscribersFactor = 50d;
    private Double startTimeFactor   = -30d;
    private Double endTimeFactor     = 0d;
    private Double startFactor       = 7d;
     ...
     * 不能为0
     */
    private Double division          = 80d;
    private Double timeBaseScore     = 2880d;
